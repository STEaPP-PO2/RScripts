...
data <- read_csv("(1) UCL MPA Digital Technologies and Policy/Term 2 _ 3 MPA Group Project/NO_Trends.csv")
...
legend("topleft", legend = c("Historical Data"), col = "blue", lty = 1)
