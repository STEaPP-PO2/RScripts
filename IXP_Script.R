...
plot(historical_time_series, type = "n", col = "blue", lwd = 2,
     main = "Historical Data and Forecasted Growth for IXPs",
...
# Add the forecasted growth values (green line) to the plot
text(seq(2024, 2028), forecast_values, labels = forecast_values, pos = 3, col = "green")
